...
public class SixDataProvider extends AbstractDataProvider {
  ...
  public static Iterator<Object[]> dpStockSummary() {
    ...
    inputs.add(new Object[]{
        new String[]{"XYZ 300", "LMN 400", "OPQ 100", "RST 500"},
        new String[]{"X", "L", "O"}, "(X : 300) - (L : 400) - (O : 100)"
    });

    inputs.add(new Object[]{
        new String[]{"JKL 150", "MNO 250", "PQR 350"}, new String[]{"J", "M"},
        "(J : 150) - (M : 250)"
    });

    inputs.add(new Object[]{
        new String[]{"ABAR 200", "CDXE 500"}, new String[]{"X", "Y"}, "(X : 0) - (Y : 0)"
    });
    ...
    inputs.add(new Object[]{
        new String[]{"ABAR 200"}, new String[]{"B"}, "(B : 0)"
    });
