...
public class SixDataProvider extends AbstractDataProvider {
    ...
    public static Iterator<Object[]> dpNbaCup() {
        ...
        inputs.add(new Object[]{resultSheetDefault, "Soft Serve QA", "Soft Serve QA:This team didn't play!"});
        inputs.add(new Object[]{resultSheetEmpty, "Soft Serve QA", "Soft Serve QA:This team didn't play!"});

        inputs.add(new Object[]{resultSheetWinFirst, "Los Angeles Clippers", "Los Angeles Clippers:W=1;D=0;L=0;Scored=104;Conceded=88;Points=3"});
        inputs.add(new Object[]{resultSheetWinSecond, "Los Angeles Clippers", "Los Angeles Clippers:W=0;D=0;L=1;Scored=88;Conceded=104;Points=0"});

        inputs.add(new Object[]{resultSheetWinFirst, "Dallas Mavericks", "Dallas Mavericks:W=0;D=0;L=1;Scored=88;Conceded=104;Points=0"});
        inputs.add(new Object[]{resultSheetWinSecond, "Dallas Mavericks", "Dallas Mavericks:W=1;D=0;L=0;Scored=104;Conceded=88;Points=3"});
