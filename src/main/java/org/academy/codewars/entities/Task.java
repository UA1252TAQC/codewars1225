...
import org.academy.codewars.entities.models.SupplierWrapper;
...
public enum Task {
    TASK1("Keep Hydrated!",
            ...
            new SupplierWrapper<>((author, params) -> author.getEight().liters((double) params.get(0))),
    ...
    TASK2("Volume of a Cuboid",
            ...
            new SupplierWrapper<>((author, params) -> author.getEight().getVolumeOfCuboid((double) params.get(0), (double) params.get(1), (double) params.get(2))),
            getRequiredArgs((scanner) -> scanner.readDouble("length"), (scanner) -> scanner.readDouble("width"), (scanner) -> scanner.readDouble("height"))),
    TASK3("Miles per gallon to kilometers per liter",
            "Sometimes, I want to quickly be able to convert miles per imperial gallon (mpg) into kilometers per liter (kpl).",
            new SupplierWrapper<>((author, params) -> author.getEight().mpgToKPM((float) params.get(0))),
    ...
    TASK4("To square(root) or not to square(root)",
            ...
            new SupplierWrapper<>((author, params) -> author.getEight().squareOrSquareRoot((int[]) params.get(0))),
    ...
    TASK5("Count of positives / sum of negatives",
            ...
            new SupplierWrapper<>((author, params) -> author.getEight().countPositivesSumNegatives((int[]) params.get(0))),
            getRequiredArgs((scanner) -> scanner.readIntArray("random number"))),
    TASK6("Convert a String to a Number!",
            "We need a function that can transform a string into a number. What ways of achieving this do you know?",
            new SupplierWrapper<>((author, params) -> author.getEight().stringToNumber((String) params.get(0))),
    ...
    TASK7("Wilson primes",
            ...
            new SupplierWrapper<>((author, params) -> author.getEight().am_i_wilson((double) params.get(0))),
    ...
    TASK8("Formatting decimal places #0",
            ...
            new SupplierWrapper<>((author, params) -> author.getEight().TwoDecimalPlaces((double) params.get(0))),
    ...
    TASK9("Find numbers which are divisible by given number",
            ...
            new SupplierWrapper<>((author, params) -> author.getEight().divisibleBy((int[]) params.get(0), (int) params.get(1))),
    ...
    TASK10("Looking for a benefactor",
            ...
            new SupplierWrapper<>((author, params) -> author.getSeven().newAvg((double[]) params.get(0), (double) params.get(1))),
    ...
    TASK11("Sum of the first nth term of Series",
            ...
            new SupplierWrapper<>((author, params) -> author.getSeven().seriesSum((int) params.get(0))),
            getRequiredArgs((scanner) -> scanner.readInt("n"))),
    TASK12("Build a pile of Cubes",
            "You are given the total volume m of the building. Being given m can you find the number n of cubes you will have to build?",
            new SupplierWrapper<>((author, params) -> author.getSix().findNb((long) params.get(0))),
    ...
    TASK13("Easy Balance Checking",
            ...
            new SupplierWrapper<>((author, params) -> author.getSix().balance((String) params.get(0))),
    ...
    TASK14("Floating-point Approximation (I)",
            ...
            new SupplierWrapper<>((author, params) -> author.getSix().f((double) params.get(0))),
            getRequiredArgs((scanner) -> scanner.readDouble("x"))),
    TASK15_1("Rainfall - mean",
            "function: mean(town, string) should return the average of rainfall for the city town and the string data or data1 (In R and Julia this function is called avg).",
            new SupplierWrapper<>((author, params) -> author.getSix().mean((String) params.get(0), (String) params.get(1))),
            getRequiredArgs((scanner) -> scanner.readString("town"), (scanner) -> scanner.readString("string"))),
    ...
    TASK16("Ranking NBA teams",
            ...
            new SupplierWrapper<>((author, params) -> author.getSix().nbaCup((String) params.get(0), (String) params.get(1))),
    ...
    TASK17("Help the bookseller !",
            ...
            new SupplierWrapper<>((author, params) -> author.getSix().stockSummary((String[]) params.get(0), (String[]) params.get(1))),
    ...
    TASK18("Gap in Primes",
            ...
            new SupplierWrapper<>((author, params) -> author.getFive().gap((int) params.get(0), (long) params.get(1), (long) params.get(2))),
    ...
    TASK19("Number of trailing zeros of N!",
            ...
            new SupplierWrapper<>((author, params) -> author.getFive().zeros((int) params.get(0))),
            getRequiredArgs((scanner) -> scanner.readInt("N"))),
    TASK20("Perimeter of squares in a rectangle",
            "The drawing shows 6 squares the sides of which have a length of 1, 1, 2, 3, 5, 8.",
            new SupplierWrapper<>((author, params) -> author.getFive().perimeter((BigInteger) params.get(0))),
    ...
    TASK21("Which x for that sum?",
            ...
            new SupplierWrapper<>((author, params) -> author.getFive().solve((double) params.get(0))),
            getRequiredArgs((scanner) -> scanner.readDouble("m"))),
    TASK22("Find the smallest",
            "You have a positive number n consisting of digits.",
            new SupplierWrapper<>((author, params) -> author.getFive().smallest((long) params.get(0))),
    ...
    private final SupplierWrapper<?> supplier;
    private final Function<ConsoleScanner, ?>[] requiredParams;

    Task(String title, String description, SupplierWrapper<?> supplier, Function<ConsoleScanner, ?>[] requiredParams) {
        this.title = title;
